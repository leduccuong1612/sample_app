Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: host, protocol: Settings.development.protocol }

  config.action_mailer.smtp_settings = {
    address: Settings.development.address,
    port: Settings.development.port,
    user_name: Settings.development.username,
